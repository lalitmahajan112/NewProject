...
public class XManagerApp {

    private static final Logger log = LoggerFactory.getLogger(XManagerApp.class);

    private final Environment env;

    public XManagerApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes XManager.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(XManagerApp.class);
